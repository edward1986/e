    ...
    for entry in existing_entries:
        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                summary = blog_content["blog"].replace('*', '').replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '')
                content = blog_content["blog"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '')
