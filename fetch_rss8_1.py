...
def insert_blog_post_to_db(title, summary, content, keywords, slug, thumbnail):
    ...
    """
    values = (
        "en", title.replace('The title is', '').replace('Here is a rewritten version of the blog post in a polished and professional tone', '').replace('Blog Post Title', '').replace('Based on the content of the revised blog post, I would recommend the following title options 1', '').replace('Your polished and professional version of the blog post is well-written, easy to follow, and provides a clear overview', '').replace('Yes, the title of this blog post is', '').replace('The title of this rewritten blog post is', '').replace('Here is a rewritten version of the blog post with a polished and professional tone', '').replace('I think your revised blog post looks great', '').replace("Here is a rewritten version of the blog post with a polished and professional tone, grammar, and readability", '').replace('The title you provided is', '').replace('Here is the polished and professional version of the blog post', '').replace("Here's the revised blog post", '').replace('The title of this blog post is', '').strip('"').replace('\n', ' '), 1, 1,
        1, title.replace('The title is', '').replace('Here is a rewritten version of the blog post in a polished and professional tone', '').replace('Blog Post Title', '').replace('Based on the content of the revised blog post, I would recommend the following title options 1', '').replace('Your polished and professional version of the blog post is well-written, easy to follow, and provides a clear overview', '').replace('Yes, the title of this blog post is', '').replace('The title of this rewritten blog post is', '').replace('Here is a rewritten version of the blog post with a polished and professional tone', '').replace('I think your revised blog post looks great', '').replace("Here is a rewritten version of the blog post with a polished and professional tone, grammar, and readability", '').replace('The title you provided is', '').replace('Here is the polished and professional version of the blog post', '').replace("Here's the revised blog post", '').strip('"').replace('\n', ' '), title.replace('The title is', '').replace('Here is a rewritten version of the blog post in a polished and professional tone', '').replace('Blog Post Title', '').replace('Based on the content of the revised blog post, I would recommend the following title options 1', '').replace('Your polished and professional version of the blog post is well-written, easy to follow, and provides a clear overview', '').replace('Yes, the title of this blog post is', '').replace('The title of this rewritten blog post is', '').replace('Here is a rewritten version of the blog post with a polished and professional tone', '').replace('I think your revised blog post looks great', '').replace("Here is a rewritten version of the blog post with a polished and professional tone, grammar, and readability", '').replace('The title you provided is', '').replace('Here is the polished and professional version of the blog post', '').replace("Here's the revised blog post", '').strip('"').replace('\n', ' '), title.replace('The title is', '').replace('Here is a rewritten version of the blog post in a polished and professional tone', '').replace('Blog Post Title', '').replace('Based on the content of the revised blog post, I would recommend the following title options 1', '').replace('Your polished and professional version of the blog post is well-written, easy to follow, and provides a clear overview', '').replace('Yes, the title of this blog post is', '').replace('The title of this rewritten blog post is', '').replace('Here is a rewritten version of the blog post with a polished and professional tone', '').replace('I think your revised blog post looks great', '').replace("Here is a rewritten version of the blog post with a polished and professional tone, grammar, and readability", '').replace('The title you provided is', '').replace('Here is the polished and professional version of the blog post', '').replace("Here's the revised blog post", '').strip('"').replace('\n', ' '),
        f'<img src="{imgbb_url1}" alt="{created_at}">' + markdown.markdown(content).replace('Here is the edited blog post', '').replace("Here's is the edited blog post", '').replace("Here is a rewritten version of the blog post with a polished and professional tone, grammar, and readability", '').replace("Here's the revised blog post", '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', ''), page_id, created_at, updated_at
    )
        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    ...
                    subject=entry["title"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', ''),
<<<<<<< HEAD
...
>>>>>>> 9b956ef7b526db0e77b9dad4ff44699a30a13fea
                ...
                title = entry["title"].replace('*', '').replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
<<<<<<< HEAD
                summary = blog_content["blog"].replace('*', '').replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
                content = blog_content["blog"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace(':', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
=======
                summary = blog_content["blog"].replace('*', '').replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace(':', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
                content = blog_content["blog"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace(':', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('\n', '<br>').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
>>>>>>> 9b956ef7b526db0e77b9dad4ff44699a30a13fea
                keywords = "SEO, website, marketing, search engines"
                slug = entry["title"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', '')
