    ...
    for entry in existing_entries:
        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                title = entry["title"].replace('*', '').replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '')
                summary = blog_content["blog"].replace('*', '').replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace(':', '').replace('Let me know if you need any further assistance', '').replace('"', '').replace('<br>', '').replace("Here's a polished and professional version of the blog post", '')
                ...
                slug = entry["title"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '')
