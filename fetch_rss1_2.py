        ...
        try:
            ...
            if "Error" not in blog_content:
                ...
                send_email(
                    ...
                    subject=entry["title"].replace('"', '').replace("Here's the polished and professional version of the blog post", '').replace('The title of the blog post is', '').replace(':', '').replace('<br>', '').replace('The title of this edited blog post is', '').replace('Based on your edited blog post, I would title it', '').replace('The title of the blog post is', '').replace('Here is the edited blog post', '').replace('Here is the revised blog post', '').replace('The title is', '').replace('The title of this blog post is', '').replace('Here is a polished and professional version of the blog post', ''),
